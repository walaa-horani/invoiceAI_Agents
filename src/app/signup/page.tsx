    ...
    <div className="min-h-screen bg-surface flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface-container-lowest rounded-2xl p-8 border border-surface-container-highest shadow-sm">
          <h2 className="text-2xl font-headline font-extrabold text-on-surface mb-1">Create workspace</h2>
          <p className="text-on-surface-variant text-sm mb-8">Set up your premium billing account</p>
